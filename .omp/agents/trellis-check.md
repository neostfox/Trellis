...
description: |
  ...
  Prefer this for post-implementation quality verification.
tools: read, bash, edit, write, search, find, lsp
...
- Do NOT remove or weaken workflow enforcement directives
